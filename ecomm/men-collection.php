...
$get_id = $_GET['token'];
// echo $get_id;
$sql = "SELECT * FROM banner WHERE page = 'men' ORDER BY id DESC LIMIT 1";
		...
		<div class="row">
			<div class="col-md-12 mb-0">
				<a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a
					...
					class="text-black">Men Collection</strong>
			</div>
		</div>
	</div>
</div>
...
<div class="site-section">
	<div class="container">
		...
		<div class="row mb-5">
						...
						<div class="d-flex">
							<div class="dropdown mr-1 ml-md-auto">
								...
								<div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
									<a class="dropdown-item" href="men-collection.php">Men</a> <a
										class="dropdown-item" href="women-collection.php">Women</a> <a
										class="dropdown-item" href="children-collection.php">Children</a>
								</div>
							</div>
							<!-- <div class="btn-group">
								<button type="button"
			...
			$sql = "SELECT * from product WHERE collection = 'men' and category = '$get_id' and stock>0";
			// echo $sql;
            $query = mysqli_query($con, $sql);
            if (! $query) {
...
?>
				<div class="product-item sm-height full-height bg-gray">
					<a href="women-collection.php" class="product-category">Women</a> <img
						src="images/feature/<?php echo $img;?>" alt="Image"
						class="img-fluid">
				</div>
			</div>
			<div class="col-lg-6">
...
?>
    ...
    ?>
					...
					</a> <img src="images/feature/<?php echo $img;?>" alt="Image"
						class="img-fluid">
				</div>
			</div>
		</div>
