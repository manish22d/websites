<footer class="site-footer custom-border-top">
      <div class="container">
        <div class="mb-5">
          <h2>Company</h2>
          <p> Empire Apparels Pvt. Ltd is an indian apparel wholesale based company. The company was established in 1991 in Delhi,India. </p>
        </div>
        <div class="row">
...
<!--           </div> -->
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            <a href="https://ankitamahaseth.com/" target="blank">
      <p>&copy; <?php echo date("Y");?> Empire Apparels Pvt. Ltd | All Rights Reserved.</p>
    </a>
            </p>
          </div>         
        </div>
...
<script type="text/javascript">
    (function () {
        var options = {
            whatsapp: "+919650480771", // WhatsApp number
            call: "+917042425007", // Call phone number
